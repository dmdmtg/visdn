...
/*
 * Hayes message types.  Do NOT use -1 as that signifies unknown type.
 */

#define	TYPE_ASSOCIATED		0
#define	TYPE_ATCOMMODE		1
#define	TYPE_ATT_CAUSE		2
#define	TYPE_ATT_DISPLAY	3
#define	TYPE_BUSY		4
#define	TYPE_CALL		5
#define	TYPE_CLEARED		6
#define	TYPE_COMPLETED		7
#define	TYPE_CONNECTED		8
#define	TYPE_DELIVERED		9
#define	TYPE_DISCONNECT		10
#define	TYPE_DISPLAY		11
#define	TYPE_ERROR		12
#define	TYPE_FEATURE		13
#define	TYPE_L3_ERROR		14
#define	TYPE_OK			15
#define	TYPE_PROCEEDING		16
#define	TYPE_PROGRESS		17
#define	TYPE_PROMPT		18
#define	TYPE_REJECTED		19
#define	TYPE_RING		20
#define	TYPE_SIGNAL		21
#define	TYPE_LAMP_QUERY		22
#define	TYPE_STATUS_QUERY	23
#define	TYPE_GREEN_LAMP		24
#define	TYPE_RED_LAMP		25
#define	TYPE_SWITCHHOOK		26
#define	TYPE_ATT_LAMP		27
#define	TYPE_VERSION		28

/*
 * Hayes action codes		(TYPE_COMPLETED)
 */
...
/*
 * Mode codes - 1st digit	(TYPE_DISPLAY)
 */
...
/*
 * Submode codes - 2nd digit	(TYPE_DISPLAY)
 */
#define	SUBMODE_DIRECT		01
	/* redirect calls will (usually?) have BOTH a called number and
	 * calling number (and names).
	*/
#define	SUBMODE_REDIRECT	02

/*
 * Feature Status codes		(TYPE_FEATURE)
 */
...
/*
 * Progress Location codes	(TYPE_PROGRESS)
 */
...
/*
 * Progress Description codes	(TYPE_PROGRESS)
 */
...
/*
 * Switchhook codes		(TYPE_SWITCHHOOK)
 */
...
/*
 * L3_ERROR message types	(TYPE_L3_ERROR)
 */
