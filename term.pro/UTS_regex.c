#ident "@(#)/usr/src/lib/libPW/regex.c	6.1.1.1 6/1/90 09:49:25 - (c) Copyright 1988, 1989, 1990 Amdahl Corporation"
...
/* These arguments: a2,a3,a4,a5 are not used within the function.  They */
/* are referenced through a1, therefore they are zapped to suppress     */
/* compiler warnings.                                                   */
regex(addrc,addrl,a1)
char *addrc, *addrl, *a1;
{
	int cur,in;
	register int *adx;
