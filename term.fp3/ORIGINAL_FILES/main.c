...
char *argv[];
{
	...
	cache(argv[0], A_NO_SHOW|A_SHARED); /* cache on terminal, don't show on more menu, shared application => multiple copie of it can run on terminal*/

	InitData(argc, argv); /* */
	
	/* spawn process that handles serial i/o with phone, function PhoneProc */
